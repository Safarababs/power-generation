...
import AddAlerts from "../components/Daily Readings/Add Alerts/Add Alerts";
...
const Alerts = ({ currentUser }) => {
  ...
  const filteredAlerts = alerts.filter((alert) => {
    ...
    const matchesSearch =
      ...
      (alert.generator &&
        alert.generator.toLowerCase().includes(searchTerm.toLowerCase()));
  ...
  return (
    <>
      <AddAlerts currentUser={currentUser} />
          ...
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-2">
              ...
              <button
                ...
                style={{
                  backgroundColor: showAcknowledged ? "#3b82f6" : "#d1d5db",
                }}
              >
                <span
                ...
                >
                  ...
                  <div className="flex-1">
                    <div className="flex items-start justify-between">
                      <div>
                        <p
                          className={`font-medium ${alert.acknowledged ? "line-through" : ""}`}
                        >
                          {alert.message}
                        </p>
                        {alert.generator && (
