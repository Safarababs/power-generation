...
import { FaShieldAlt, FaPowerOff, FaSync, FaExclamationTriangle, FaFileAlt, FaClock } from 'react-icons/fa';
        ...
        <div className="grid grid-cols-2 gap-4">
          {actions.map((action, index) => (
            ...
            >
              ...
              <span className="text-xs text-secondary mt-1">{action.description}</span>
            </button>
          ))}
        </div>
      </div>
